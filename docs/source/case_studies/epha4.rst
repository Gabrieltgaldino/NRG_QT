...
The top 20 ligands will be plotted in the PyMOL interface in a group called 'NRGRank' also a list of all results will be shown in the tab Results in NRGRank menu. Search for 'DB04868'—this is the pose generated by NRGRank.
