...
In this tutorial, we will reproduce a few results regarding the evolution of the SARS-CoV-2 Spike protein. We will employ tools available at NRGSuite-Qt to study its conformatioal dynamics, binding affiity to ACE2 and antibody recognition.
