...
.. tabs::
    ...
    .. group-tab:: Windows
        ...
        Download **NRGSuite Qt** for Windows `here <https://github.com/NRGlab/NRGSuite-Qt/releases/download/v2025.14.1/NRGSuite_Qt_windows.zip>`_.

    .. group-tab:: MacOS

        Download **NRGSuite Qt** for MacOS `here <https://github.com/NRGlab/NRGSuite-Qt/releases/download/v2025.14.1/NRGSuite_Qt_mac.zip>`_.
